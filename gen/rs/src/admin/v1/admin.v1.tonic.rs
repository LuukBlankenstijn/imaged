        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/admin.v1.AdminService/GetAllHosts",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("admin.v1.AdminService", "GetAllHosts"));
        ...
        pub async fn update_host_name(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/admin.v1.AdminService/UpdateHostName",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("admin.v1.AdminService", "UpdateHostName"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/admin.v1.AdminService/GetAllHosts" => {
                    ...
                    struct GetAllHostsSvc<T: AdminService>(pub Arc<T>);
                    ...
                    for GetAllHostsSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as AdminService>::get_all_hosts(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/admin.v1.AdminService/UpdateHostName" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateHostNameSvc<T: AdminService>(pub Arc<T>);
                    impl<
                        T: AdminService,
                    ...
                    for UpdateHostNameSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdminService>::update_host_name(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
