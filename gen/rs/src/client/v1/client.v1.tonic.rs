...
pub mod client_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn start_stream(
            &mut self,
            request: impl tonic::IntoRequest<super::StartStreamRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/client.v1.ClientService/StartStream",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("client.v1.ClientService", "StartStream"));
...
pub mod client_service_server {
    ...
    pub trait ClientService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the StartStream method.
        type StartStreamStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn start_stream(
            ...
            tonic::Response<Self::StartStreamStream>,
            tonic::Status,
        >;
    }
    ///
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/client.v1.ClientService/StartStream" => {
                    ...
                    struct StartStreamSvc<T: ClientService>(pub Arc<T>);
                    impl<
                        T: ClientService,
                    > tonic::server::ServerStreamingService<super::StartStreamRequest>
                    for StartStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ClientService>::start_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
